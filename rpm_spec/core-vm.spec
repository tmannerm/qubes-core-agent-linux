...
/usr/lib/modules-load.d/qubes-misc.conf
...
%{_unitdir}/ntpd.service.d/30_qubes.conf
...
%{_userunitdir}/pulseaudio.service.d/30_qubes.conf
%{_userunitdir}/pulseaudio.socket.d/30_qubes.conf
